...
Команда разработки:
- :white_check_mark: [Александр (в роли Python-разработчика Тимлид - разработчик 1)]
- :white_check_mark: [Татьяна (в роли Python-разработчика - разработчик 2)]
- :white_check_mark: [Артур роль (в роли Python-разработчика - разработчик 3)]
